...
System.loadLibrary(Core.NATIVE_LIBRARY_NAME); //loading core library
...
public class CameraSnapshotJavaFX extends Application {
    ...
    public void saveImage() {
        // Saving the Image
        String file = "E:/OpenCV/chap22/snapshot.jpg";
    ...
    // Detecting the sleeve orientation  in the snap
    MatOfRect sleeveDetection = new MatOfRect();
    classifier.detectMultiScale(src, sleeveDetection);
}
